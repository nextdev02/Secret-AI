  ...
  return ( 
    <div>
      ...
      <div className="px-4 lg:px-8">
        ...
        <div className="space-y-4 mt-9 mb-8">
          {isLoading && (
           ...
           <div className="flex flex-col-reverse gap-y-4 transition">
            {messages.map((message) => (
              <div 
                key={message.content} 
                className={cn(
                  "p-8 w-full flex items-start gap-x-8 rounded-lg transition",
                  message.role === "user" ? "bg-white border border-black/10" : "text-white bg-neutral-800",
                )}
              >
